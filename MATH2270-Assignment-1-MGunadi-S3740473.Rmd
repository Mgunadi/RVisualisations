...
Fatalities4 <- Fatalities3 + labs(title = "Total Fatalities", x = "Occupation", y = "Total fatalities") + annotate("text", x = 6.7, y = 4, label = "2", size = 3, face = "bold") + annotate("text", x = 4, y = 74, label = "71") + theme(plot.title = element_text(size = 16, face = "bold"), axis.text = element_text(size = 14), axis.title = element_text(size = 14, face = "bold"))
