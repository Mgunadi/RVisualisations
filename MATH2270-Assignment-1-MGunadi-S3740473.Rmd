...
Fatalities2 <- Fatalities + geom_col(position = "dodge2", aes(fill = Year), binwidth = 1) + theme(axis.text.x=element_text(angle = 60, vjust = 0.5)) + facet_grid(Statistic ~ .,) + scale_fill_manual(values = colorRampPalette(brewer.pal(3, "Reds"))(3))
